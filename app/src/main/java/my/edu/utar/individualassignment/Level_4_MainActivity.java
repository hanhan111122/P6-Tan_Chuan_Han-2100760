...
public class Level_4_MainActivity extends Activity {
    private Button box1, box2, box3, box4, box5, box6, box7, box8, box9, box10, box11, box12, box13, box14, box15, box16,box17,box18,box19,box20,box21,box22,box23,box24,box25;
    ...
    private void promptContinueOrExit(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Level_4_MainActivity.this);
...
//here need to change to intent new level
                Intent i = new Intent(Level_4_MainActivity.this,Level_5_MainActivity.class);
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(Level_4_MainActivity.this,InputName.class);
                i.putExtra("Level", 4);
    ...
    private void highlightRandomBox() {
        ...
        int highlightedBox = random.nextInt(25) + 1;
